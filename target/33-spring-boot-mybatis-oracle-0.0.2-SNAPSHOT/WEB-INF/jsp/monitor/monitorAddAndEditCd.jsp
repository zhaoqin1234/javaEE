            ...
            <div style="padding:5px;">
	           	...
	           	<table style="table-layout:fixed;">
		            <tr height="35px">
		                ...
		                <td style="width:150px;">    
		                    <input name="site_id" id="site_id" class="mini-combobox" textField="name" valueField="id"    value="HBn4JTnVa2"  allowInput="false"
		                ...
		                <td style="width:150px;">    
		                    <input name="yc_id" id="yc_id" class="mini-combobox" textField="name" valueField="id"  allowInput="false"
	            ...
	            <tr height="35px">
	                   <td style="width:150px;" align="right">井号：</td>
		                <td >    
		                    <input name="well_id" id="well_id" class="mini-combobox" textField="wellCommonName" valueField="wellId"  allowInput="false"
	                    ...
	                    <td > 
	                      <input id="stime" name="stime" valueType="string" class="mini-monthpicker" format="yyyy-MM"style="width:150px;" allowInput="false"  showTime="false" />
	                    </td>
	                </tr> 
	             <tr height="35px">
	                    ...
	                    <td > 
	                  <input id="cs_type_id" name="cs_type_id" class="mini-combobox" style="width:150px;" textField="jcjh_name" valueField="jcjh_id"  allowInput="false"
	                  ...
	                  <!--  <td style="width:150px;" align="right">测试内容：</td>
		                ...
		                <td colspan="3">  
		                 <input id="fail_mesg" name="fail_mesg"class="mini-textbox" allowInput="false" />   
		                </td>
	               ...
	               <tr height="35px">
	                    ...
	                    <td > 
	                          <input name="cs_claim" id="cs_claim" class="mini-textbox" allowInput="false" />
	                    </td>
	                 	<td align="right">生产井段（m）：</td>
	                    <td >    
	                        <input name="well_section" id="well_section" class="mini-textbox"  floatErrorText="请输入数字" allowInput="false"/>
	                    </td>
	                </tr> 
	              <tr height="35px">
	               	...
	               	<td align="right">厚度（m）：</td>
	                    <td > 
	                        <input name="thickness" id="thickness" class="mini-textbox"  required="true" floatErrorText="请输入数字" allowInput="false" />
	                    </td>
	              	<td align="right">层数：</td>
	                    <td >    
	                        <input name="plies_num" id="plies_num" class="mini-textbox" floatErrorText="请输入数字" allowInput="false"/>
	                    </td>
	                </tr> 
	                <tr height="35px">

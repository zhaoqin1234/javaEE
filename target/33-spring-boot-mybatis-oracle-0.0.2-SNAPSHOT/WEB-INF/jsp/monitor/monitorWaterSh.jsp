...
<script type="text/javascript">
	...
	function add(){
		...
		function edit(){
			...
			mini.open({
	            url: "<%=basePath%>monitor/monitorAddAndEditWaterCd",
	            title: "编辑测试计划井号", 
	            width:  800, 
	            height: 550,
	            onload: function () {
...
<body style="width: 98%;height: 96%">
		<div class="mini-toolbar" id="toolbar1">
			...
			<input id="dateType" class="mini-combobox" textField="text" valueField="id"  value="tc_date" emptyText="日期类型" style="width:120px;" allowinput="true" shownullitem="false"  showClose="true" oncloseclick="onCloseClick"/>
				<span class="separator"></span> 
			<input id="tj_status" class="mini-combobox" textField="text" valueField="id" showClose="false"  style="width:100px;" allowinput="false" shownullitem="false" emptyText="全选" />

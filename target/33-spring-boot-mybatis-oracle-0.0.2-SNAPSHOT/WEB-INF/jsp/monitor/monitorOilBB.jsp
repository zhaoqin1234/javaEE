...
<script type="text/javascript">
	...
	function exportData(){
		...
		var siteIds = mini.get("site_id").getValue(); //工区Id
		var siteNames = mini.get("site_id").getText(); //工区名称
		var grid = mini.get("datagrid");
		
		window.location.href="<%=basePath%>oiljcjh/dwnloadOilJCJHReport?site_id="+siteIds+"&date="+date+"&siteNames="+siteNames;
	}
...
<body style="width: 98%;height: 97%">
	<div id="div1" style="width: 100%;height: 100%">
		...
		<div id="datagrid" class="mini-datagrid" style="width:100%;height:92%;" url="<%=basePath%>oiljcjh/getOilJCJHBBByType"  allowCellWrap="true" ondrawcell="ondrawcell"   enableHotTrack="true"

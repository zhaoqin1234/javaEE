...
<html>
<head>
<title>措施计划数据导入</title>
</head>
<body style="width: 98%;height: 97%">
	<fieldset style="border:solid 1px #aaa;padding:3px;">
        <legend>措施计划模板下载</legend>	
		<table>
			<tr>
...
<script type="text/javascript">
	var time,title,state_id,yc_id,step_type;
	time = getTodayMonth();
	mini.parse();
	...
	function download(){
		...
		var url='<%=basePath%>csjh/dwnloadCsjhTmp?stime='+time+'&tj_status='+state_id+'&fileName='+title+'&well_step_id='+well_step_id
	...
	function uploadFile(){
		...
		$.ajaxFileUpload({
			url:'<%=basePath%>csjh/excelUpdateCsjh?step_type='+step_type,

...
<script type="text/javascript">
	...
	function add(){
		...
		function edit(){
			...
			mini.open({
	            url: "<%=basePath%>monitor/monitorAddAndEditCd",
	            title: "编辑测试计划井号", 
	            width:  800, 
	            height: 550,
	            onload: function () {
...
<body style="width: 98%;height: 97%">
	<div id="div1" style="width: 100%;height: 100%">
		<div class="mini-toolbar" id="toolbar1">
			...
			<span class="separator"></span> 
			<input id="tj_status" class="mini-combobox" textField="text" valueField="id" showClose="false"  style="width:65px;" allowinput="false" shownullitem="false" emptyText="全选"/>
			<span class="separator"></span> 

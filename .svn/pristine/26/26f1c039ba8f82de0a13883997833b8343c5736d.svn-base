		...
		<div class="mini-splitter" style="width:100%;height:100%;">
    		...
    		<div showCollapseButton="true" >
    			<div class="mini-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;">                
		            ...
		            <span class="separator"></span>             
		            <a class="mini-button" iconCls="icon-remove" onclick="getMenuIds()">获取ids</a>                    
        		</div>
       			<div class="mini-fit" >
	    			<div id="datagrid" class="mini-datagrid" style="width:100%;height:100%;" url="<%=basePath%>menu/getMenuByMenu" pageSize="20" showPager="true" 
						...
						<div property="columns">
							...
							<div field="name" headerAlign="center" align="center" headerStyle="font-weight: bold;">菜单名称</div>
							<!--  
			          		...
			          		-->
			          		<div field="url" headerAlign="center" align="center" headerStyle="font-weight: bold;">URL</div>
			          		...
			          		<div field="orderNumber" headerAlign="center" align="center" headerStyle="font-weight: bold;">排序</div>
			          		<!--    
...
<script type="text/javascript">
	...
	function add(){
		...
		mini.open({
            url: "<%=basePath%>authority/menu_Edit",
            title: "新增菜单信息", 
            width: 550, 
            height: 350,
            onload: function () {
	...
	function remove(){
		...
		if(row){
			if (confirm("确定删除选中记录？")){
				$.ajax({
                    url: "<%=basePath%>menu/delMenuByMenu",
                    dataType:'text',
                    async: false,
                    data: {
                    	id: row.id

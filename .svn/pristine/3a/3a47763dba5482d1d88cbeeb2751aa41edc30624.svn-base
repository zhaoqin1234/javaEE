...
public class OilJCJH {
    ...
    private String level_demand;          //NUMBER 需求程度（0：正常；1：急需；2：可缓）
    ...
    private String sh_status;             //NUMBER 审核状态  0未审核 1审核
    ...
    //report  使用
    private String xm; 		//项目  油井  水井   报表导出使用
    private String flag;	//1 油井  2  水井 
    private String xh; 		//序号   措施第几条
    private String sum_px;  //措施总共有几行
    private String sum_co;  //油井总共有几行 
    private String sjyy;    //时间及原因   未测成时间及原因 
	...
	public String getSum_px() {
		return sum_px;
	}
	public void setSum_px(String sum_px) {
		this.sum_px = sum_px;
	}
	public String getSum_co() {
		return sum_co;
	}
	public void setSum_co(String sum_co) {
		this.sum_co = sum_co;
	}
	...
	public String getLevel_demand() {
		return level_demand;
	}
	public void setLevel_demand(String level_demand) {
	...
	public String toString() {
		return "OilJCJH [seq=" + seq + ", site_id=" + site_id + ", site_name=" + site_name + ", yc_id=" + yc_id
				+ ", yc_name=" + yc_name + ", well_id=" + well_id + ", well_name=" + well_name + ", cs_type_id="
				+ cs_type_id + ", cs_type_name=" + cs_type_name + ", well_section=" + well_section + ", thickness="
				+ thickness + ", cs_purpose=" + cs_purpose + ", cs_explaim=" + cs_explaim + ", cs_claim=" + cs_claim
				+ ", last_success_date=" + last_success_date + ", recently_fail_date=" + recently_fail_date
				+ ", recently_revise_mesg=" + recently_revise_mesg + ", level_demand=" + level_demand + ", tc_date="
				+ tc_date + ", fk_cd_date=" + fk_cd_date + ", wcd_mesg=" + wcd_mesg + ", success_date=" + success_date
				+ ", fail_mesg=" + fail_mesg + ", create_date=" + create_date + ", update_date=" + update_date
				+ ", tj_status=" + tj_status + ", sh_status=" + sh_status + ", stime=" + stime + ", plies_num="
				+ plies_num + "]";
	}

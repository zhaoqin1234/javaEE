		...
		<div class="mini-splitter" style="width:100%;height:100%;">
    		...
    		<div showCollapseButton="true" >
    			<div class="mini-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;">                
       			...
       			<div class="mini-fit" >
	    			<div id="datagrid" class="mini-datagrid" style="width:100%;height:100%;" url="<%=basePath%>deptment/getDeptmentsByDeptment" pageSize="20" showPager="true" 
						...
						<div property="columns">
							...
							<div field="name" headerAlign="center" align="center" headerStyle="font-weight: bold;">部门名称</div>
			          		<div field="image_name" headerAlign="center" align="center" headerStyle="font-weight: bold;">部门图标名称</div>
			          		<div field="status" headerAlign="center" align="center" headerStyle="font-weight: bold;" >状态</div>
			          		<div field="mark" headerAlign="center" align="center" headerStyle="font-weight: bold;">备注信息</div>
			            </div>
	    			</div>
    			</div>
    		</div>
...
<script type="text/javascript">
	...
	function add(){
		...
		mini.open({
            url: "<%=basePath%>authority/deptmentEdit",
            title: "新增部门信息", 
            width: 550, 
            height: 350,
            onload: function () {
	...
	function remove(){
		...
		if(row){
			if (confirm("确定删除选中记录？")){
				$.ajax({
                    url: "<%=basePath%>deptment/delDeptmentByDeptment",
                    dataType:'text',
                    async: false,
                    data: {
                    	id: row.id

...
<script type="text/javascript">
	...
	function download(){
		...
		title = "测试计划模板";
		var url='<%=basePath%>waterjcjh/dwnloadWaterJCJHTmp?stime='+time+'&site_id='+state_id+'&fileName='+title+'&yc_id='+yc_id+'&well_id='+well_id;
	...
	function uploadFile(){
		...
		$.ajaxFileUpload({
			url:'<%=basePath%>waterjcjh/excelUpdateWaterJCJH',

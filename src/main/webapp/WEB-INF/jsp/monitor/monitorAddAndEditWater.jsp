...
<!-- 	                        <input name="level_demand" id="level_demand" class="mini-textbox" value="正常"/> -->
	                     ...
	                     <input id="level_demand" name="level_demand" class="mini-combobox" style="width:150px;" textField="text" valueField="id"  allowInput="true"
	           ...
	           <tr height="35px">
	             ...
	             <tr height="35px">
	                   ...
	                   <td style="width:150px;" align="right">测试要求日注水量：</td>
		                <td colspan="3">  
		                 <input id="cs_water_injection" name="cs_water_injection"class="mini-textbox"  />   
		                </td>
	                </tr> 
	              <tr height="35px">

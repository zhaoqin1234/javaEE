...
<html>
<head>
<title>月配注数据管理模板下载</title>
</head>
<body>
	<fieldset style="border:solid 1px #aaa;padding:3px;">
        <legend>月配注数据管理模板下载</legend>	
		<table>
			<tr>
...
<script type="text/javascript">
	...
	function download(){
		...
		title = "月配注数据管理模板";
		//var url='<%=basePath%>monthPZ/dwnloadTmp?stime='+time+'&orgId='+state_id+'&fileName='+title+'&siteId='+yc_id+'&wellId='+well_id;
		var url='<%=basePath%>monthPZ/dwnloadTmp?stime='+time+'&state_id='+state_id+'&fileName='+title+'&yc_id='+yc_id+'&well_id='+well_id;
	...
	function uploadFile(){
		...
		$.ajaxFileUpload({
			url:'<%=basePath%>monthPZ/excelUpdateMonthPZ',

	...
	<fieldset style="border:solid 1px #aaa;padding:3px;">
		...
		<table>
			...
			<tr>
				<td>井号:</td>
				<td>
					<input name="well_id" id="well_id" class="mini-combobox" textField="wellCommonName" valueField="wellId" onvaluechanged="setYcAndWellTypeByWellName"
...
<script type="text/javascript">
	...
	//根据井号设置油藏
	function setYcAndWellTypeByWellName(){
		ycName=wellObj.siteName ;
		ycId=wellObj.siteId;
		ycObj.setValue(ycId);
		ycObj.setText(ycName);
	}

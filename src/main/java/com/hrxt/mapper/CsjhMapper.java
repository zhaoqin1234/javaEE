...
public interface CsjhMapper {
	...
	//以下是   报表备注的增删改查
	public String p_dzs_report_note_insert(Map<String, Object> param);
	
	public String p_dzs_report_note_update(Map<String, Object> param);
	
	public String p_dzs_report_note_delete(Map<String, Object> param);
	
	public String p_dzs_report_note_select(Map<String, Object> param);

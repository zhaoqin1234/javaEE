...
public interface MonthPZMapper {
	...
	/**
	 * 月配注 报表    insert  or update    分开写了 废弃
	 * @param param
	 * @return
	 */
	...
	String p_dzs_insert_ypzbb(Map<String, Object> param);
	
	String p_dzs_update_ypzbb(Map<String, Object> param);
	...
	List<Dzs_pz_report_summary> selectAllDZS_PZ_REPORT_SUMMARY();
}
